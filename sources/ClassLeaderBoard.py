...
class MagicLeaderBoard(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        s = ttk.Style(self)
        s.theme_use('clam')
        s.configure('Blue.TButton', background='white', foreground='royalblue4',font=('helvetica', 12, 'bold'),bordercolor="midnight blue")
       ...
       # self.leaderboard = ttk.LabelFrame(self, text = "Class Leaderboard", width=parent.screen_width/4, height=parent.screen_height,borderwidth=8,relief=tk.GROOVE,style='Red.TLabelframe')
        self.c_canvas= tk.Canvas(self,background='white')
        ...
        self.savebutton = ttk.Button(self.dataframe,width=5,text="Save",style='Blue.TButton',command=self.save_data,cursor="arrow")
        ...
        self.headernamelabel = ttk.Label(self.leaderboard, text="Name", font = ('helvetica', 16),background='white', foreground = 'royalblue4')
        self.headerbadgelabel = ttk.Label(self.leaderboard, text="Badge", font=('helvetica', 16),background='white', foreground='royalblue4')
        self.headerpointslabel = ttk.Label(self.leaderboard, text="Points", font=('helvetica', 16),background='white', foreground='royalblue4')
    ...
    def c_function(self,event):
       self.c_canvas.configure(scrollregion=self.c_canvas.bbox("all"),width=295,height=500)
    ...
    def refresh_data(self):
       ...
       # self.leaderboard.configure(state="normal")
        ...
        for element in list_names:
            self.datanamelabel = ttk.Label(self.leaderboard, text=element[0].strip(), font = ('helvetica', 12),
                                           foreground = 'royalblue4',wraplength = 100,background='white')
            ...
            self.datapointspinner = ttk.Spinbox(self.leaderboard,background='white',foreground='royalblue4',font=('helvetica', 12),
           ...
           # self.datapointslabel = ttk.Label(self.leaderboard, text=element[2], font=('helvetica', 12),
