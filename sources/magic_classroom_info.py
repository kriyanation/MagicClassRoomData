...
class MagicClassRoomData(tk.Toplevel):
    ...
    def __init__(self,parent,*args,**kwargs):
        ...
        self.thought_button = ttk.Button(self.thought_frame, text="Submit", command=lambda: DataCaptureClass.save_thought(self.thought_text.get()), style="classroom.TButton")
        ...
        self.leveltwospinner = ttk.Spinbox(self.leaderboard_frame, background='beige', foreground='brown',
                                           ...
                                           width=2)
        self.points_button = ttk.Button(self.leaderboard_frame, text="Set Points", command=lambda: DataCaptureClass.set_points(self.min_lev1_var.get(),self.min_lev2_var.get()),
    ...
    def add_participants(self,participant_text):
        DataCaptureClass.add_participants(participant_text)
        self.leaderboard_frame.grid_forget()
        self.leaderboard.destroy()
        self.leaderboard = FlashLeaderBoard.MagicLeaderBoard(self.leaderboard_frame)
        self.display_student_panel()
    def remove_participants(self,participant_text):
        DataCaptureClass.remove_participants(participant_text)
        self.leaderboard_frame.grid_forget()
        self.leaderboard.destroy()
        self.leaderboard = FlashLeaderBoard.MagicLeaderBoard(self.leaderboard_frame)
        self.display_student_panel()
